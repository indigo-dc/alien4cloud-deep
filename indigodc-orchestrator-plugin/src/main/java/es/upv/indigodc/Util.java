...
public class Util {
  ...
  public static InstanceStatusInfo indigoDCStatusToInstanceStatus(final String status) 
      throws JsonProcessingException, IOException {
    switch (status) {
      case "UNKNOWN": return new InstanceStatusInfo(InstanceStatus.FAILURE, "UNKNOWN");
      case "CREATE_COMPLETE": return new InstanceStatusInfo(InstanceStatus.SUCCESS, "CREATE_COMPLETE");
      case "CREATE_FAILED": return new InstanceStatusInfo(InstanceStatus.FAILURE, "CREATE_FAILED");
      case "CREATE_IN_PROGRESS": return new InstanceStatusInfo(InstanceStatus.PROCESSING, "CREATE_IN_PROGRESS");
      case "DELETE_COMPLETE": return new InstanceStatusInfo(InstanceStatus.SUCCESS, "DELETE_COMPLETE");
      case "DELETE_FAILED": return new InstanceStatusInfo(InstanceStatus.FAILURE, "DELETE_FAILED");
      case "DELETE_IN_PROGRESS": return new InstanceStatusInfo(InstanceStatus.PROCESSING, "DELETE_IN_PROGRESS");
      case "UPDATE_COMPLETE": return new InstanceStatusInfo(InstanceStatus.SUCCESS, "UPDATE_COMPLETE");
      case "UPDATE_FAILED": return new InstanceStatusInfo(InstanceStatus.FAILURE, "UPDATE_FAILED");
      case "UPDATE_IN_PROGRESS": return new InstanceStatusInfo(InstanceStatus.PROCESSING, "UPDATE_IN_PROGRESS");
      default: throw new NotFoundException("Status \"" + status + "\" not supported yet");
    }
  }
