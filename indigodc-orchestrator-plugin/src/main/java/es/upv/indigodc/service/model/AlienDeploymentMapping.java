...
public class AlienDeploymentMapping {
  ...
  /**
   * The id of the whole deployment (basically the instance if the topology launched at one time on the orchestrator)
   */
  private String deploymentId;
  /**
   * The id of the orchestrator on which the deployment with the id {@link #deploymentId} has been launched
   */
