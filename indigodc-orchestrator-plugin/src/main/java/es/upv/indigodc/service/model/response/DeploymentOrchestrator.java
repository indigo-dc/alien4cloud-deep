...
/**
 * The information about a deployment returned when getting the list of deployments. For more
 * information check the Indigo Orchestrator help.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class DeploymentOrchestrator {
  ...
  /** The endpoint of the cloud provider where the deployment has been made / has been attempted. */
