...
public class EventService {
  ...
  protected final Buffer eventQueue =
      BufferUtils.synchronizedBuffer(new CircularFifoBuffer(EVENT_QUEUE_MAX_SIZE));
  ...
  //  /**
  //   * Subscribe to the event service that loads the events from the orchestrator by polling it
  // every
  //   * X seconds.
  //   *
  ...
  ////            PaaSDeploymentStatusMonitorEvent statusEv = new
