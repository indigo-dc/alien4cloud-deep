...
public class OrchestratorResponseTest {
	...
	public void parseOutputsSingleKeyListValue() throws JsonProcessingException, IOException {
		...
		OrchestratorResponse or = new OrchestratorResponse(200, response);
	...
	public void codeNotOkInResponse() throws JsonProcessingException, IOException {
		OrchestratorResponse or = new OrchestratorResponse(199, new StringBuilder(""));
		assertTrue(!or.isCodeOk());
		or = new OrchestratorResponse(200, new StringBuilder(""));
		assertTrue(or.isCodeOk());
		or = new OrchestratorResponse(299, new StringBuilder(""));
		assertTrue(or.isCodeOk());
		or = new OrchestratorResponse(300, new StringBuilder(""));
		assertTrue(!or.isCodeOk());
	}
