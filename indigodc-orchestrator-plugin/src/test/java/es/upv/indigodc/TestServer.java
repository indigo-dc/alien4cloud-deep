...
public class TestServer {    
  ...
  /**
   * Wrapper class for a embedded jetty server. Use for testing only, and in a security reliable environment
   * 
   ...
   */
  public TestServer(int port, int securePort, String keystorePath,
      String keystorePass, String managerPass) throws FileNotFoundException {
    this.port = port;
    ...
    connectorHttps = new ServerConnector(server,
  ...
  public int getPort() throws Error{
    if (connectorHttp == null)
      // If the programmer hasn't initialized this class by calling start, then the whole test should be terminated
