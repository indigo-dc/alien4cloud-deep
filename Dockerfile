...
RUN apk add --no-cache openjdk8-jre-base bash \
  ...
  && python3 indigodc-2-a4c.py ${A4C_INSTALL_PATH}/indigo-dc-tosca-types/ < ${A4C_INSTALL_PATH}/indigo-dc-tosca-types/custom_types.yaml > ${A4C_INSTALL_PATH}/indigo-dc-tosca-types/tosca_types_alien.yaml \
